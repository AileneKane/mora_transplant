...
#tsmegermdat<-na.omit(tsmegermdat2)
dim(tsmegermdat)
...
consgermmod.tsme<-glmmadmb(tsmey ~ Stand+Origin+Canopy+Understory +Stand:Origin+Stand:Canopy+Stand:Understory+Origin:Canopy+Origin:Understory+Canopy:Understory+Stand:Canopy:Understory+(1|Block),family="binomial", data=tsmegermdat, zeroInflation =TRUE)#now merge in microclimate variables
Anova(consgermmod.tsme, type="III")
